...
public class Populator implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                ShelterModel shelterModel5 = new ShelterModel("Robotic Dog Shelter", "2125 This Way",
                                ...
                                "wow17@gmail.com", "image path will go here", "website");
                shelterModel4.setID(5L);
                shelterService.saveShelter(shelterModel5);

                // Shelter 6
                ShelterModel shelterModel6 = new ShelterModel("Resting Shelter", "2125 This Way",
                                "Ste 205", "City", "OH", "43004", "614888888",
                ...
                AdopterModel adopterModel3 = new AdopterModel("Johann", "Adress 1", "Address 2", "Columbia",
                                "SC", "22222", "689453217", "wow113@gmail.com", "pic will go here", PetTypeEnum.DOG,
                                AdoptionStatusEnum.DENIED,
                ...
                AdopterModel adopterModel4 = new AdopterModel("Gretel", "Adress 1", "Address 2", "Detroit",
                                "MI", "22222", "689453217", "wow131@gmail.com", "pic will go here",
                ...
                AdopterModel adopterModel5 = new AdopterModel("Greta", "Adress 1", "Address 2", "Redwood",
                                "CA", "00000", "689453217", "wow111@gmail.com", "pic will go here",
                                PetTypeEnum.ROBOTIC_DOG, AdoptionStatusEnum.REQUESTED,
                                "pending review");
                adopterModel5.setID(5L);
                adopterModel5.setShelterModel(shelterModel5); // added adopter to shelter 5
                adopterService.saveAdopter(adopterModel5);

                AdopterModel adopterModel6 = new AdopterModel("Bobby", "Adress 1", "Address 2", "Columbia",
                                "MS", "22222", "689453217", "wow191@gmail.com", "pic will go here",
                                PetTypeEnum.ROBOTIC_CAT, AdoptionStatusEnum.DENIED,
                                "high school student, mom needs to sign");
                adopterModel6.setID(4L);
                adopterModel6.setShelterModel(shelterModel6); // added adopter to shelter 6
                ...
                OrganicPetModel organicPetModel1 = new OrganicPetModel("Bonobo", PetTypeEnum.CAT, "image url goes here",
                                "calico", 3, PetHealthEnum.HEALTHY, PetMoodEnum.RELAXED, PetTemperamentEnum.THOUGHTFUL,
                                true,
                                null, null);
                ...
                OrganicPetModel organicPetModel2 = new OrganicPetModel("Bruno", PetTypeEnum.DOG, "image url goes here",
                                "collie", 4, PetHealthEnum.HEALTHY, PetMoodEnum.EXCITED, PetTemperamentEnum.ACTIVE,
                                true,
                                null, null);
                organicPetModel2.setID(2L);
                organicPetModel2.setShelterModel(shelterModel2); // added organicPet to shelter 2
                organicPetService.saveOrganicPet(organicPetModel2);

                OrganicPetModel organicPetModel3 = new OrganicPetModel("Bandera", PetTypeEnum.ROBOTIC_CAT,
                                "image url goes here",
                                "orange", 1, PetHealthEnum.SICK, PetMoodEnum.DEPRESSED, PetTemperamentEnum.SUSPICIOUS,
                                true,
                                null, null);
                organicPetModel3.setID(3L);
                organicPetModel2.setShelterModel(shelterModel3); // added organicPet to shelter 3
                ...
                OrganicPetModel organicPetModel4 = new OrganicPetModel("Billy", PetTypeEnum.DOG, "image url goes here",
                                "husky", 3, PetHealthEnum.HUNGRY, PetMoodEnum.ANXIOUS, PetTemperamentEnum.HOT_HEADED,
                                true,
                                null, null);
                organicPetModel4.setID(4L);
                organicPetModel4.setShelterModel(shelterModel4); // added organicPet to shelter 4
                organicPetService.saveOrganicPet(organicPetModel4);

                // ROBOTIC PETS
                RoboticPetModel roboticPetModel1 = new RoboticPetModel("Chimp", PetTypeEnum.ROBOTIC_CAT,
                                "image url goes here",
                                "2.0", "Samsung", 10, 100, RoboticPetHealthEnum.LOW_BATTERY,
                                null, null);
                roboticPetModel1.setID(1L);
                roboticPetModel1.setShelterModel(shelterModel5); // added robotic pet to shelter 5
                roboticPetService.saveRoboticPet(roboticPetModel1);

                RoboticPetModel roboticPetModel2 = new RoboticPetModel("Orangutan", PetTypeEnum.ROBOTIC_DOG,
                                "image url goes here",
                                "2.2", "HP", 50, 80, RoboticPetHealthEnum.NORMAL,
                                null, null);
                roboticPetModel2.setID(2L);
                roboticPetModel2.setShelterModel(shelterModel5); // added robotic pet to shelter 5
                roboticPetService.saveRoboticPet(roboticPetModel2);

                RoboticPetModel roboticPetModel3 = new RoboticPetModel("Coco", PetTypeEnum.ROBOTIC_CAT,
                                "image url goes here",
                                "2.0", "Boeing", 1, 1, RoboticPetHealthEnum.MALFUNCTION,
                                null, null);
                roboticPetModel3.setID(3L);
                roboticPetModel3.setShelterModel(shelterModel1); // added robotic pet to shelter 1
                roboticPetService.saveRoboticPet(roboticPetModel3);

                RoboticPetModel roboticPetModel4 = new RoboticPetModel("Meringue", PetTypeEnum.ROBOTIC_DOG,
                                "image url goes here",
                                "2.2", "Dell", 50, 83, RoboticPetHealthEnum.NORMAL,
                                null, null);
                roboticPetModel4.setID(4L);
                // roboticPetModel4.setShelterModel(shelterModel5); //added robotic pet to
                // shelter 5
                roboticPetService.saveRoboticPet(roboticPetModel4);

                // PET MAINTENANCE
                PetMaintenanceModel petMaintenanceModel1 = new PetMaintenanceModel("Feeding", 2, PetTypeEnum.DOG,
                                PetTaskEnum.FEED_PET);
                petMaintenanceModel1.setId(1L);
                petMaintenanceService.savePetMaintenance(petMaintenanceModel1);

                PetMaintenanceModel petMaintenanceModel2 = new PetMaintenanceModel("Cleaning enclosure", 2,
                                PetTypeEnum.ROBOTIC_DOG, PetTaskEnum.CLEAN_ENCLOSURE);
                petMaintenanceModel2.setId(2L);
                petMaintenanceService.savePetMaintenance(petMaintenanceModel2);

                PetMaintenanceModel petMaintenanceModel3 = new PetMaintenanceModel("Water", 2, PetTypeEnum.CAT,
                                PetTaskEnum.WATER_PET);
                petMaintenanceModel3.setId(3L);
                petMaintenanceService.savePetMaintenance(petMaintenanceModel3);

                PetMaintenanceModel petMaintenanceModel4 = new PetMaintenanceModel("Water", 2, PetTypeEnum.ROBOTIC_CAT,
